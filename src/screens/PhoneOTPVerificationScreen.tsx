...
import {verifyPhoneOTP, resendPhoneOTP} from '../services/signupService';
...
type PhoneOTPRouteProp = RouteProp<RootStackParamList, 'PhoneOTPVerification'>;
...
const PhoneOTPVerificationScreen: React.FC = () => {
  ...
  useEffect(() => {
    // Prevent skipping: must come from step 3
    if (step < 3) {
  ...
  }, [otp, email, expiryTimer, navigation]);
